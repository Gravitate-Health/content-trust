...
public interface VerificationCanonicalizer {
     ...
     * @throws VerificationCanonicalizationException when parsing fails.
     */
    byte[] processForVerification(byte[] data) throws VerificationCanonicalizationException;
     ...
     * @throws VerificationCanonicalizationException when parsing fails.
     */
    String processForVerification(String data) throws VerificationCanonicalizationException;
}
